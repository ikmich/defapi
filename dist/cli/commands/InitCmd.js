...
var _request_1 = __importDefault(require("../../helpers/_request"));
/**
 * Command handler for the `apidef init` command.
 */
var InitCmd = /** @class */ (function (_super) {
    __extends(InitCmd, _super);
    function InitCmd() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    InitCmd.prototype.run = function () {
        return __awaiter(this, void 0, void 0, function () {
            var baseUri, _a, res, raw, resBody, e_1;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0: return [4 /*yield*/, _super.prototype.run.call(this)];
                    case 1:
                        _b.sent();
                        baseUri = config_util_1.default.getPropBaseUri();
                        _b.label = 2;
                    case 2:
                        _b.trys.push([2, 4, , 5]);
                        return [4 /*yield*/, _request_1.default({
                                baseUri: baseUri,
                                method: "POST",
                                path: constants_1.API_PATH_INIT,
                            })];
                    case 3:
                        _a = _b.sent(), res = _a.res, raw = _a.raw;
