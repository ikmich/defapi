...
const init_defs_controller_1 = __importDefault(require("./controllers/init-defs-controller"));
...
defapiRouter.post(constants_1.API_PATH_GENERATE_DEFS, (req, res) => {
    return init_defs_controller_1.default(req, res, false);
});
/**
 * Update endpoint defs
 */
defapiRouter.post(constants_1.API_PATH_UPDATE_DEFS, (req, res) => {
    return init_defs_controller_1.default(req, res, true);
});
