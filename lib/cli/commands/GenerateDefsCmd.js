...
exports.GenerateDefsCmd = void 0;
 ...
 */
class GenerateDefsCmd extends BaseCmd_1.default {
    run() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            let raw;
            try {
                const result = yield http_request_1.default({
                    baseUri,
                    method: 'POST',
                    path: constants_1.API_PATH_GENERATE_DEFS
                });
                res = result.res;
                raw = result.raw;
                const resBody = JSON.parse(raw);
                if (res.statusCode === 200) {
                    conprint_1.default.success('Success');
                }
                else {
                    conprint_1.default.error('Error');
                }
...
exports.GenerateDefsCmd = GenerateDefsCmd;
